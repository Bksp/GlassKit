...
- **Lightweight & Fast:** Bundled with Vite for optimal development and production performance.
...
To run the local development server and preview the components:
...
This will generate the distributable files in the `dist/` directory, including the ES module (`glasskit-ui.es.js`) and the UMD build (`glasskit-ui.umd.js`).
